...
('2025-01-09 11:30:00', TRUE, 'Bon état', 'Réception commande 3', 1, 1);
...
-- FULLY PAID
INSERT INTO paiement (montant, date_, id_commande) VALUES (9120.00, '2025-01-11 15:00:00', 4);
...
-- Stock entry from this delivery
INSERT INTO mvt_stock (date_, entrant, description_qualite, designation, id_livraison, id_depot) VALUES 
('2025-01-12 10:30:00', TRUE, 'Excellent état', 'Réception commande 4', 2, 2);
...
INSERT INTO mvt_stock (date_, entrant, description_qualite, designation, id_livraison, id_depot) VALUES 
('2025-01-19 13:30:00', FALSE, NULL, 'Vente 7 écrans - Commerce 123', NULL, 2);
INSERT INTO mvt_stock_lot (id_mvt, id_lot, qte) VALUES (6, 4, 7);
UPDATE lot SET qte = qte - 7 WHERE id_lot = 4;

-- ========================================
-- FINAL STOCK STATE:
-- LOT-CHAISE-001: 10/15 remaining (5 sold)
-- LOT-STYLO-001: 70/100 remaining (30 sold)
-- LOT-ORD-001: 5/8 remaining (3 sold)
-- LOT-ECRAN-001: 5/12 remaining (7 sold)
-- ========================================