...
3	iPhone 15 Pro - Lot automatique	60	60	6
\.
...
SELECT pg_catalog.setval('public.demande_achat_id_da_seq', 1, true);
...
SELECT pg_catalog.setval('public.historique_general_id_hg_seq', 11, true);
...
SELECT pg_catalog.setval('public.livraison_id_livraison_seq', 1, true);
...
SELECT pg_catalog.setval('public.lot_id_lot_seq', 3, true);
...
SELECT pg_catalog.setval('public.mvt_caisse_id_mvtc_seq', 1, true);
...
SELECT pg_catalog.setval('public.mvt_stock_id_mvt_seq', 1, true);
...
SELECT pg_catalog.setval('public.paiement_id_paiement_seq', 1, true);
...
SELECT pg_catalog.setval('public.proforma_id_proforma_seq', 1, true);
...
SELECT pg_catalog.setval('public.validation_step_id_validation_step_seq', 4, true);
